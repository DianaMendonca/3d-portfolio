  ...
  return (
    <Tilt className="xs:w-[250px] w-full">
      <motion.div
        ...
        style={{
          boxShadow: "0px 0px 10px 3px #ea5193",
        }}
      >
        <div
          option={{
...
const About = () => {
  return (
    <>
      ...
      >
        I'm a young Full Stack developer with experience in JavaScript, HTML, CSS,
        C++, Ruby, and expertise in frameworks like React, Ruby on
        Rails and Three.js. I'm a quick learner and collaborate closely with

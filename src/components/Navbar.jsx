    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          ...
          {/* GitHub logo as the last item in the desktop view */}
          <li className="text-white hover:text-white text-[18px] font-medium cursor-pointer">
            <a
              href="https://github.com/GoncaloMendonca" // Replace with your GitHub profile URL
              target="_blank"
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          <img
            ...
            alt="menu"
            className="w-[18ps] h-[28px] object-contain cursor-pointer"
          ...
          >
            <ul className="list-none flex justify-end items-start flex-col gap-4">
              ...
              {/* GitHub link in the mobile view */}
